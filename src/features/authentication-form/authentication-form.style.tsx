...
export const ErrorReferralSpan =  styled.span`
font-size: 10px;
color: ${themeGet('colors.primary.regular', 'red')};
font-weight: bold;
`;

export const ReferralSuccessSpan = styled.span`
font-size: calc(${themeGet('fontSizes.base', '10')}px - 1px);
font-weight: bold;
`;

export const MainError = styled.span`
font-size: 14px;
color: ${themeGet('colors.primary.regular', 'red')};
text-align: center;
font-weight: 600;
